...
(function() {
  ...
  var CCD = {
    ...
    renderDrawerShell: function() {
      ...
      var drawerHtml = '<div class="ccd-drawer-contents">' +
        '<div class="ccd-fixed-header">' +
          ...
          '</div>' +
        '</div>' +
        '<div class="ccd-loading-skeleton" data-ccd-skeleton style="display:none"><div class="ccd-skeleton__progress"></div><div class="ccd-skeleton"><div class="ccd-skeleton__img"></div><div class="ccd-skeleton__lines"><div class="ccd-skeleton__line"></div><div class="ccd-skeleton__line ccd-skeleton__line--medium"></div><div class="ccd-skeleton__line ccd-skeleton__line--short"></div></div></div><div class="ccd-skeleton"><div class="ccd-skeleton__img"></div><div class="ccd-skeleton__lines"><div class="ccd-skeleton__line"></div><div class="ccd-skeleton__line ccd-skeleton__line--short"></div></div></div><div class="ccd-skeleton__footer"><div class="ccd-skeleton__btn"></div></div></div><div class="ccd-inner" data-ccd-inner style="display:none">'  +
    ...
    init: function() {
      ...
      // VERSION STAMP
      console.log('%c[CCD v16.2] Universal theme suppression — early observer + continuous polling + section strip', 'background:#6b21a8;color:#fff;padding:4px 8px;border-radius:4px;font-weight:bold');
      window.__ccd_version = '16.2';
    ...
    changeQty: function(key, qty, btnEl) {
      ...
      window.__ccd_last_cart = cart;
        ...
        if (_pendingOp) {
          ...
          if (p.qty === 0) {
            ...
            if (qItem && !qItem.classList.contains('ccd-item--removing')) {
              ...
              setTimeout(function() { if (qItem.parentNode) qItem.remove(); }, 280);
            }
          }
        ...
        if (_isRemoving) {
          ...
          if (_ct) { _ct.classList.add('ccd-price-updating'); _ct.textContent = CCD.fmt(CCD.getAdjustedTotal(cart)); setTimeout(function(){_ct.classList.remove('ccd-price-updating');},150); }
    ...
    morphDOM: function(container, newCartItems) {
      ...
      newList.forEach(function(n) {
        if (existMap[n.key]) {
          ...
          if (exPrice && nPrice && exPrice.textContent !== nPrice.textContent) { exPrice.classList.add('ccd-price-updating'); exPrice.textContent = nPrice.textContent; setTimeout(function(){exPrice.classList.remove('ccd-price-updating');},150); }
