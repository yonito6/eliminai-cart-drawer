...
(function() {
  ...
  var CCD = {
    ...
    init: function() {
      ...
      // VERSION STAMP
      console.log('%c[CCD v16.0] Theme-independent cart drawer loaded — triple-fix (flash+debounce+$0)', 'background:#6b21a8;color:#fff;padding:4px 8px;border-radius:4px;font-weight:bold');
      window.__ccd_version = '16.0';
