        ...
        '<div class="ccd-fixed-header">' +
          '<div class="ccd-header">' +
            ...
            '<div class="ccd-close" style="display:flex;align-items:center;gap:4px">' +
              ((window.Shopify && (window.Shopify.shop === "eliminai-test.myshopify.com" || window.Shopify.shop === "eleganto-3011.myshopify.com")) ? '<button onclick="window._ccdShowDebug()" style="background:#eee;border:1px solid #ccc;color:#333;font:10px monospace;padding:2px 6px;cursor:pointer;border-radius:4px" title="Debug">DBG</button>' : '') +
