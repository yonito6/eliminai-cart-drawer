...
(async () => {
  ...
  if (data.errors) console.error('Upload errors:', JSON.stringify(data.errors));
  else console.log('Uploaded to DEMO:', data.asset.key, '| updated_at:', data.asset.updated_at);
  await p.$disconnect();
})();
