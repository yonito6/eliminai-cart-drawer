...
export const ADDON_DEFINITIONS: AddonDefinition[] = [
...

  {
    ...
    icon: '🏆',
    description:
      'Set item-based milestones (free shipping, buy-X-get-Y, etc.) to encourage larger orders.',
    ...
    dimensions: [
      ...
      {
        key: 'milestone1Goal',
        label: 'Milestone 1 — Items Needed',
        type: 'number',
        testable: false,
        default: 1,
        min: 1,
      ...
      },
      {
        ...
        testable: false,
        default: '',
        placeholder: 'e.g. 2+1 FREE',
      },
      {
        key: 'milestone2Goal',
        label: 'Milestone 2 — Items Needed',
        type: 'number',
        testable: false,
        default: 3,
        min: 2,
    ...
    defaultConfig: { milestone1Label: '', milestone1Goal: 1, milestone2Label: '', milestone2Goal: 3, position: 'above-items' },
  },
