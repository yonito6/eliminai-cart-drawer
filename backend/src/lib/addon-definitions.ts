...
export const ADDON_DEFINITIONS: AddonDefinition[] = [
...

  {
    ...
    icon: '⚡',
    description: 'Show your store\u2019s native Shopify express wallets (Shop Pay, Apple Pay, PayPal, Google Pay\u2026) directly in the cart. Only the wallets your checkout supports appear.',
